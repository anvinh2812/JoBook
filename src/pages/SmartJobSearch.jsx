    ...
    return (
        <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                <h1 className="text-2xl font-bold text-gray-900 mb-2">Tìm việc thông minh</h1>
                <p className="text-gray-600 mb-4">Nhập tiêu chí của bạn (ví dụ: "intern, chưa có kinh nghiệm, reactjs, full stack, nodejs, java").</p>
